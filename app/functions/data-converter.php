...
function donationConverter($data=array(),$controller){        
    $result = array();
    if( count($data) > 0){
        for($i = 0 ;$i < count($data);$i++){
            $edited='<center><a href="'.route('adminsystem.'.$controller.'.getForm',['edit',@$data[$i]['id']]).'"><img src="'.asset("/public/adminsystem/images/edit-icon.png").'" /></a></center>';
            ...
            $result[$i] = array(
                ...
                "id"                       =>   $id,
                "fullname"                 =>   $data[$i]["fullname"],      
                "total_cost"               =>   fnPrice($data[$i]["total_cost"]) ,
                "donated_cost"             =>   fnPrice($data[$i]["donated_cost"]),                                         
                "sort_order"               =>   $sort_order,
                "status"                   =>   $status,
                "created_at"               =>   datetimeConverterVn($data[$i]["created_at"]),
                "updated_at"               =>   datetimeConverterVn($data[$i]["updated_at"]),
    ...
    if( count($data) > 0){
        for($i = 0 ;$i < count($data);$i++){
            ...
            $result[$i] = array(
                ...
                "id"                       =>   $id,
                "fullname"                 =>   $data[$i]["fullname"],  
                "donation_name"            =>   $data[$i]["donation_name"],                              
